...
Run the appropriate Python script for the desired algorithm (dqn.py for DQN, ppo.py for PPO).
Follow the instructions provided in the script to configure hyperparameters and choose the benchmark environment (Atari or Mujoco).
After training, evaluate the trained models using the provided evaluation script or directly within the training script.
